...
$(document).ready(function() {
    ...
    function(e) {
        e.fn.mMenu = function(t) {
            ...
            e('.m-menu__nav .m-menu__item.m-menu__item--submenu.m-menu__item--hover[data-menu-submenu-toggle="click"]').each(function() {
                ...
                (menu = a.mMenu(), "dropdown" === menu.getSubmenuMode()) && (0 == e(t.target).is(a) && 0 == a.find(e(t.target)).length && a.find('.m-menu__item--submenu.m-menu__item--hover[data-menu-submenu-toggle="click"]').each(function() {
    ...
    function(e) {
        e.fn.mWizard = function(t) {
            var a = this,
                ...
                o = {
                    ...
                    goTo: function(e) {
                        if (e !== a.currentStep) return !1 !== ((e = e ? parseInt(e) : o.getNextStep()) > a.currentStep ? o.eventTrigger("beforeNext") : o.eventTrigger("beforePrev")) && (a.currentStep = e, o.updateUI(), o.eventTrigger("change")), e > a.startStep ? o.eventTrigger("afterNext") : o.eventTrigger("afterPrev"), a
                    },
                    updateUI: function(e) {
        ...
        if (s.horizontal ? (e = s.base, t = s.x, a = s.y - s.height / 2, n = s.y + s.height / 2, o = t > e ? 1 : -1, i = 1, l = s.borderSkipped || "left") : (e = s.x - s.width / 2, t = s.x + s.width / 2, a = s.y > 2 * c ? s.y - c : s.y, o = 1, i = (n = s.base) > a ? 1 : -1, l = s.borderSkipped || "bottom"), d) {
...
var mLayout = function() {
    ...
    return {
        ...
        initHeader: function() {
            ...
            }, 6e3), (n = $("#m_quicksearch")).mQuicksearch({
                type: n.data("search-type"),
        ...
        initAside: function() {
            var a;
            a = $("#m_aside_left").hasClass("m-aside-left--offcanvas-default") ? "m-aside-left--offcanvas-default" : "m-aside-left", t = $("#m_aside_left").mOffcanvas({
                    class: a,
                    overlay: !0,
                ...
                function() {
                    var t = $("#m_ver_menu"),
                        a = {
                            submenu: {
                                desktop: {
                                    default: 1 == t.data("menu-dropdown") ? "dropdown" : "accordion",
                                    state: {
                    ...
                    if (e = t.mMenu(a), t.data("menu-scrollable-")) {
                        function n(e) {
                            if (mUtil.isInResponsiveRange("tablet-and-mobile")) mApp.destroyScroller(e);
                            else {
